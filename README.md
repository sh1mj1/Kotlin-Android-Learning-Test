# Learning Tests Repository (Kotlin & Android)

이 저장소는 **Kotlin 및 Android 관련 학습 테스트(Learning Tests)** 를 작성하고 공유하는 공간입니다.

## 🔍 학습 테스트란?

학습 테스트는 **새로운 기술을 배울 때, API나 언어 차원의 기능들을 직접 테스트 코드로 작성해보는 방식**입니다.

이렇게 함으로써:

- **꼼꼼하고 섬세하게 학습할 수 있습니다.**  
  → 테스트를 직접 작성하면서 기능을 깊이 이해할 수 있습니다.
- **테스트 코드 작성을 더 빠르고 자연스럽게 할 수 있습니다.**  
  → 연습을 통해 테스트 코드 작성 감각을 기를 수 있습니다.
- **빠르게 참조할 수 있는 학습 자료가 됩니다.**  
  → 나중에 필요할 때 기존 테스트 코드를 참고하여 빠르게 활용할 수 있습니다.

## 🏗 저장소의 구성

이 저장소에서는 **Kotlin과 Android 개발과 관련된 학습 테스트**를 다룹니다.

### 📂 주요 내용

- **Kotlin 기본 문법 및 고급 기능 테스트**
- **Android Framework 및 Jetpack 라이브러리 테스트**
- **Compose 및 XML 기반 UI 테스트**
- **Coroutine 및 Flow 관련 테스트**
- **Dependency Injection (Hilt, Koin 등) 테스트**
- **Android의 네트워크, 데이터 저장소, 테스트 관련 기능 실험**

## 🎯 이 저장소의 목적

1. **테스트 코드 작성 능력 향상**
    - 테스트 코드를 시니어 개발자만큼 빠르게 작성하지 못하더라도, 꾸준히 연습하면서 감각을 기릅니다.
2. **테스트 코드에 관심 있는 Android 개발자들에게 영감 제공**
    - 최근 많은 개발자들이 테스트 코드에 관심을 가지고 있습니다.
    - 이 저장소가 **테스트 코드 작성에 대한 레퍼런스** 역할을 할 수 있도록 합니다.
3. **오픈 소스로 확장하여 함께 학습하기**
    - 장기적으로 이 저장소를 **오픈 소스로 공개하고, 다른 Android 개발자들과 함께 테스트 코드를 작성**하는 것이 목표입니다.

## 🚀 기여 방법

아직 오픈 소스로 운영되지 않지만, 향후 오픈 소스 프로젝트로 발전시킬 계획입니다.  
관심 있는 분들은 **이슈를 등록하거나 PR을 보내면서 참여할 수 있도록 준비할 예정**입니다.

## 📌 앞으로의 계획

- 다양한 **Kotlin & Android 기술**에 대한 학습 테스트 추가
- 코드 품질을 유지하면서 **테스트 코드 패턴 연구**
- 오픈 소스 프로젝트로 발전하여 여러 개발자들과 협업

---

✅ **이 저장소가 더 나은 테스트 코드 작성을 위한 유용한 참고 자료가 되기를 바랍니다!**
